		...
		<div id="list-author" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<g:sortableColumn property="authorName" title="${message(code: 'author.authorName.label', default: 'Author Name')}" />
				...
				<g:each in="${authorInstanceList}" status="i" var="authorInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${authorInstance.id}">${fieldValue(bean: authorInstance, field: "authorName")}</g:link></td>
